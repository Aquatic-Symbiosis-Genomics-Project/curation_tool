  ...
  def submit_to_lsf
    ...
    ["primary", "haplotigs"].each { |key|
      if self.yaml.as_h.has_key?(key)
        ...
        ascc = "/lustre/scratch123/tol/teams/tola/users/ea10/20231026_ascc_test_clone/cobiontcheck"
